...
Cấu trúc liên kết mạng hình kim tự tháp
Lớp này thực hiện một cấu trúc liên kết kim tự tháp. Trong cấu trúc liên kết này, các hạt được kết nối bằng các đơn giản N chiều.
"""
