...
# Lớp cơ sở cho các cấu trúc liên kết
# Bạn có thể sử dụng lớp này để tạo cấu trúc liên kết của riêng bạn. Lưu ý rằng mọi cấu trúc liên 
kết nên triển khai một cách để tính toán (1) hạt tốt nhất, (2) vị trí tiếp theo và (3) vận tốc tiếp 
theo cho thuộc tính của Swarm tại một bước thời gian nhất định. Không thực hiện các phương pháp này sẽ gây ra lỗi.
"""
