...
Lớp này thực hiện một cấu trúc liên kết vòng. Trong cấu trúc liên kết này, 
các hạt được kết nối với k lân cận gần nhất của chúng. Hành vi xã hội này thường được tìm thấy 
trong các trình tối ưu hóa LocalBest PSO.
"""
