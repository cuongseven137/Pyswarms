...
Lớp này thực hiện một cấu trúc liên kết hình sao. Trong cấu trúc liên kết này, tất cả các hạt đều được
kết nối với nhau. Hành vi xã hội này thường được tìm thấy trong các trình tối ưu hóa GlobalBest PSO.
"""
