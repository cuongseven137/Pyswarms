...
# Thuật toán Tối ưu hóa bầy đàn nhị phân (binary PSO).

# Nó cần một tập hợp các giải pháp ứng cử viên và cố gắng tìm ra giải pháp tốt nhất bằng 
# cách sử dụng phương pháp cập nhật tốc độ vị trí. Không giống như pyswarms.single.gbvà pyswarms.single.lb, 
# kỹ thuật này thường được áp dụng cho các vấn đề nhị phân rời rạc như lập lịch cho cửa hàng việc làm, giải trình tự, 
