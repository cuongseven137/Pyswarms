...
Thuật toán Tối ưu hóa bầy đàn tốt nhất toàn cầu (gbest PSO).
Nó cần một tập hợp các giải pháp ứng cử viên và cố gắng tìm ra giải pháp tốt nhất 
bằng cách sử dụng phương pháp cập nhật tốc độ vị trí. Sử dụng cấu trúc liên kết hình sao 
trong đó mỗi hạt bị thu hút bởi hạt hoạt động tốt nhất.
