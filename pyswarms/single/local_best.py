...
Thuật toán Tối ưu hóa bầy đàn hạt tốt nhất cục bộ (lbest PSO).
Tương tự như PSO tốt nhất toàn cầu, nó cần một tập hợp các giải pháp ứng cử viên và tìm ra giải pháp tốt nhất 
bằng cách sử dụng phương pháp cập nhật tốc độ vị trí. Tuy nhiên, nó sử dụng cấu trúc liên kết vòng, do đó làm 
cho các hạt bị thu hút vào vùng lân cận tương ứng của nó.
